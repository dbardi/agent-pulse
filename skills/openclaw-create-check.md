# Agent Pulse — Create New Check (OpenClaw)
...
## Using with OpenClaw
To have OpenClaw create a new check:
```bash
openclaw chat "Load the skill from skills/openclaw-create-check.md and create a check that monitors <your thing>"
```
